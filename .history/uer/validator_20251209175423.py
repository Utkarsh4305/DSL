...
Provides comprehensive validation for UER-compliant embeddings.
Checks dimension, dtype, normalization, geometry, and other spec requirements.
"""
...
class UERValidator:
    ...
    def __init__(self, spec: Dict[str, Any]):
        ...
        """
        self.spec = spec
        self._norm_eps = spec.get('normalization_rules', {}).get('epsilon', 1e-12)
        self._norm_tolerance = spec.get('validation_rules', {}).get('norm_tolerance', 1e-6)
        self._dim_tolerance = spec.get('validation_rules', {}).get('dimension_tolerance', 0.0)
