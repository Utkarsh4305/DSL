...
def demo_advanced_validation():
    ...
    print("
Anisotropy Analysis:")
    print(".1f"    print(".3f"    print(f"  Recommendation: {anisotropy_results['recommendation']}")
    ...
    print(".3f")
    print(".1f"    if dist_results['warnings']:
    ...
    try:
        ...
        print("✅ Zero vector handled successfully"        print(f"   Result norm: {np.linalg.norm(result):.6f} (automatically fixed)")
